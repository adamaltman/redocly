...
<Jumbotron>
  <NavBar location={props.location} standalone={false} search={false}  />
  ...
  <Flex p={20} justifyContent="center">
    ...
    <Button  large to="developer-portal/index.md">
      Get started
    </Button>
...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1} header="Rock">
      ...
      adipiscing. Nibh zril labitur an usu.Lorem ipsum dolor sit amet, pri
      putent oportere quaerendum in, ea mea justo invenire aliquando. Usu modo
      suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur an
      usu.Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea
      justo invenire aliquando. Usu modo suavitate ea. Et sed labitur epicurei
      adipiscing.
    </ThinTile>
    <ThinTile
